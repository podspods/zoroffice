...
const meta: Meta<typeof AggregatedPage> = {
  title: 'pages/StatisticsAggregated',
...
export const ProfileOnly: Story = {
  args: {
    typeStatList: [profileStat]
  }
};

export const NoRights: Story = {
  // args: {
  //   typeStatList: []
  // }
};
...
export const UserOnly: Story = {
  args: {
    typeStatList: [userStat]
  }
};

export const UserAndGroup: Story = {
  args: {
    typeStatList: [userStat, groupStat]
  }
};


export const UserGroupAndProfile: Story = {
  args: {
    typeStatList: [userStat, groupStat, profileStat]
  }
};
...
const fakeDataProfileView = {
  data: [
    ...
    },
    {
      ...
      targetLanguage: 'EN',
      profileName: 'ProfileSharedWithGroup',
      profileId: 'fakec9fb-7ce8-4ff1-9845-7971577c87fc',
      selectors: {
        domain: 'Generic',
        owner: 'Systran',
        size: 'L',
