...
const meta: Meta<typeof AdministrationStatisticsAggregated> = {
  ...
  title: 'statistic/delivery/Aggregated',
  ...
  parameters: {
    msw: {
      handlers: [
        ...
        rest.get(Apis.statistics.byUser('anonymous'), async (req, res, ctx) => {
          return res(ctx.delay(10), ctx.json(fakeDataUserView.anonymous));
        }),
        rest.get(Apis.statistics.byUser('Scim_1'), async (req, res, ctx) => {
          return res(ctx.delay(10), ctx.json(fakeDataUserView.Scim_1));
        }),
        rest.get(
          Apis.statistics.byUser('Administrator'),
          async (req, res, ctx) => {
        ...
        rest.get(Apis.statistics.byGroup('Systran'), async (req, res, ctx) => {
          return res(ctx.delay(10), ctx.json(fakeDataGroupView.Systran));
        }),
        rest.get(
          Apis.statistics.byGroup('Administrator'),
          async (req, res, ctx) => {
            return res(
              ctx.delay(10),
        ...
        rest.get(Apis.statistics.byGroup('others'), async (req, res, ctx) => {
