...
export const PostApi = {
  createProfile: async (data: RequestDataCreate) => {
    ...
    return await commonFetch(Apis.profiles.createProfile, header);
  },
  activateProfiles: async ({profileId, sesProfileId}: {profileId: string; sesProfileId: string}) => {
    ...
    return await commonFetch(Apis.profiles.activateProfiles, header);
  },
  deactivateProfiles: async ({profileId, sesProfileId}: {profileId: string; sesProfileId: string}) => {
    ...
    return await commonFetch(Apis.profiles.deactivateProfiles, header);
  },
  deleteProfiles: async ({profileId, service}: {profileId: string; service: string}) => {
    ...
    return await commonFetch(Apis.profiles.deleteProfiles, header);
  },
  updateProfile: async (data: unknown) => {
    ...
    return await commonFetch(Apis.profiles.updateProfile, header);
  },
  editProfile: async (data: RequestDataEdit) => {
    ...
    return await commonFetch(Apis.profiles.editProfile, header);
  }
};
