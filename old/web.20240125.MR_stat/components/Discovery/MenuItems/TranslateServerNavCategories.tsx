  ...
  navItems: [
    ...
    { icon: <NavBarIcons shape='rectangleHistory' />, title: 'Translation Resources', link: '/administration/translationResources', validateFct: () => check([(actions as any).ADMIN_BASE]) },
    {
      icon: <NavBarIcons shape='chart' />, title: 'Advanced Statistics', nestedItems: [
        { title: 'Users', link: '/administration/statistics/user', validateFct: () => check((actions as any).USERS_STATS) },
        { title: 'Groups', link: '/administration/statistics/group', validateFct: () => check((actions as any).GROUPS_STATS) },
        { title: 'Profiles', link: '/administration/statistics/global', validateFct: () => check([(actions as any).ADMIN_STATS, (actions as any).AGGREGATED_STATS]) },
        { title: 'Sessions', link: '/administration/statistics/session', validateFct: () => check((actions as any).ADMIN_STATS) },
        { title: 'Full View', link: '/administration/statistics/details', validateFct: () => check((actions as any).ADMIN_STATS) },
