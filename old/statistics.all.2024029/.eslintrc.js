module.exports = {
  ...
  extends: ['plugin:@systran/eslint-plugin-systran/common', 'plugin:@systran/eslint-plugin-systran/react', 'plugin:@next/next/recommended', 'plugin:storybook/recommended'],
  root: true,
  env: {
    node: true,
    es6: true
