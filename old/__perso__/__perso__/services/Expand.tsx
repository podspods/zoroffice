...
import { displayByte, durationFromNow, elapsedTime, roundOneDigit } from '../../app/[lang]/administration/serverManagement/services/components/serviceUtils';
import LinkTo from './LinkTo';


export default function Expand(
  params: GridRowParams<Service>
): React.ReactNode {
  const lineList: DisplayLineProps[] = expandText(params.row);
