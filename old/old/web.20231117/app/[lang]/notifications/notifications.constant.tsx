...
import { NotificationDisplay, Status } from './notifications.type';
...
export const PAGINATION_STEP = [1, 2, 3, 5, 8, 13, 21, 34];
...
// ];
export const leftActionList: RowAction<NotificationDisplay>[] = [
  {
    label: MARK_AS_READ,
    icon: <PlusIcon />,
