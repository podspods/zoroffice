...
import { NotificationInput, Status } from './notifications.type';
...
export const PAGINATION_STEP = [3, 5, 8, 13, 21, 34];
...
// ];
export const leftActionList: RowAction<NotificationInput>[] = [
  {
    label: MARK_AS_READ,
    icon: <PlusIcon />,
    onClick: (params) => void markAsReadOne(params[0].id),
    disable: () => false
  },
  {
    label: MARK_AS_UNREAD,
    icon: <PlusIcon />,
    onClick: (params) => void markAsUnReadOne(params[0].id),
    disable: () => false
  }
];
...
export const toolbarElement: RowAction<NotificationInput>[] = [
  {
    label: MARK_AS_READ,
    icon: <PlusIcon />,
