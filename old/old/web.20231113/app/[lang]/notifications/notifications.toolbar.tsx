...
import { SEARCH, notificationsActions } from './notifications.constant';
    ...
    <Toolbar>
      <LeftSide>
        <RefreshRateButton
          ...
          onRefresh={props.setRefresh}
          refreshRate={props.refreshRate}
          onRefreshChange={props.refreshChange}
        />
        <RowActionToolbar
          actions={props.leftActionList}
          selectedRows={props.checkedList}
        />
      </LeftSide>
      <RightSide>
        <BaseButton
