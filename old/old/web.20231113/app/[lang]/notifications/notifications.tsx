...
import { PAGINATION_STEP, URL_HOST, URL_PORT, URL_PROTOCOLE } from './notifications.constant';
import {
  NotificationColumn,
  SortOrder,
  notificationsRoute
...
export async function getNotification(
  ...
  if (filterStr && filterStr.length >= 0) {
    ...
    console.log('response getRequest 51==>', response);

    return response;
  }
  const response = await commonFetch(getRequest, { method: 'GET' });
  console.log('response getRequest  56==>', getRequest);
  return response;
}
