...
import { Item } from './SelectLevel';
import { getLevelId } from './notification.common';
import { markAllAsRead, markAsRead, markAsUnRead } from './notification.store';
export const PAGE_NAME = 'Notification';
export const REFRESH = 'Refresh';
export const MARK = 'Mark';
export const MARK_AS_READ = 'Mark as read';
export const MARK_AS_UNREAD = 'Mark as read';
export const MARK_ALL_AS_READ = 'Mark all as read';
export const LEVEL = 'Level';
export const READ = 'Read';
export const NOT_READ = 'not read';
export const NOTIFICATIONS = 'Notifications';
export const INSERT_AT = 'Insert at';
