...
import PersonalStatisticTableV1 from './component/PersonalStatisticTable';

const meta: Meta<typeof PersonalStatisticTableV1> = {
  // eslint-disable-next-line storybook/no-title-property-in-meta
  title: 'testing/MyStatistic-V1',
  component: PersonalStatisticTableV1,
  parameters: {
    msw: {
      handlers: [
