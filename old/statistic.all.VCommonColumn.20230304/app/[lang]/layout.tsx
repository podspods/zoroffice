...
import {TrsLinks} from '@/components/Navigation/UserPopover';
    ...
    <html lang='en'>
      ...
      <body style={{display: 'flex', fontFamily: 'Quicksand'}}>
        <ClientLayout theme={theme}>
          <MenuDiscovery lang={params.lang} MenuLogo={MenuLogo} hideSystranLogoNavBar={customConfig.hideSystranLogo} documentationLink={customConfig.onlineDocumentation} trsLinks={customConfig.trsLinks}>
            {children}
          </MenuDiscovery>
        </ClientLayout>
      </body>
