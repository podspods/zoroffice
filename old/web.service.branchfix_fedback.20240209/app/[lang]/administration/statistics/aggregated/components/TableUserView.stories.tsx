...
const meta: Meta<typeof TableUserView> = {
  title: 'pages/Statistics/TableUserView',
  component: TableUserView,
  parameters: {
    args: {
      onChangeTypeStat: (typeStat: string) => action('change type-stat')(typeStat),
      typeStat: 0,
      onChangePeriode: (period: string) => action('change period')(period),
      period: '2023-12'
    },
    msw: {
      handlers: [
