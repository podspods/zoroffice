...
const meta: Meta<typeof Notifications> = {
  ...
  title: 'statistic/emile/notifications',
...
const notifications = {
  ...
  notifications: [
    ...
    {
      id: '64889399e09e8e0e381d233e',
      insertedAt: '2023-06-13T16:04:41.973Z',
      level: 'info',
      str: {
        display: 'File ${filename} successfully translated',
        data: {
          filename: {
            type: 'fileTranslation',
            value: '521e2bd3-21dc-42e5-a252-f594903070b0',
            label: 'doc-to-read.md'
          }
        },
        v: 2
      },
    ...
    },
    {
      ...
      level: 'info',
      str: {
        display: 'teest ${filename} successfully translated',
        data: {
          filename: {
            type: 'fileTranslation',
            value: '521e2bd3-21dc-42e5-a252-f594903070b0',
