...
import DisplayIcon, { IconeName } from '@/components/Services/components/DisplayIcon';


export const UNKNOW = 'unknow';
export const INFO_DISPLAY_ACTIONS =
...
export const actionDeRegisterEllipsis: RowAction<Service> = {
  icon: DisplayIcon(IconeName.DELETE),
  label: DEREGISTER,
...
export const actionRegister: RowAction<Service> = {
  icon: DisplayIcon(IconeName.PLUS),
