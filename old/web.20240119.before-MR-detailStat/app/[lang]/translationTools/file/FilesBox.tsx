...
import TranslationProfileSettings from '@systran/react-components/lib/TranslateBox/V3/SettingExpansion/items/TranslationProfileSettings';
import GeneralLanguagePreferences from '@systran/react-components/lib/TranslateBox/V3/SettingExpansion/items/GeneralLanguagePreferences';
        ...
        ? (<>
          ...
          <S.Row>
            ...
            <S.ActionButtons>
              ...
              <S.TranslateButton>
                <PrimaryButton onClick={handleUploadClick}>{t('Translate')}</PrimaryButton>
              </S.TranslateButton>
            </S.ActionButtons>
          </S.Row>
        </>)
        : <div style={{marginTop: '32px'}}>{slots.UploadedFilesTable}</div>
      }
    </S.Container>
  );
}
