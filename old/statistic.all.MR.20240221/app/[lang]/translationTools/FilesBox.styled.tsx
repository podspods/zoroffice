...
import TranslationFormLight from '@systran/react-components/lib/organisms/TranslateBox/TranslationFormV4/TranslationFormLight';
...
export const Form = styled(TranslationFormLight)`
  padding: 0px 10px;
  display: flex;
