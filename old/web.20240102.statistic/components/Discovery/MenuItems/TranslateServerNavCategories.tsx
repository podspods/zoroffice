  ...
  navItems: [
    ...
    { icon: <NavBarIcons shape='rectangleHistory' />, title: 'Translation Resources', link: '/administration/translationResources', validateFct: () => check([(actions as any).ADMIN_BASE]) },
    {
      icon: <NavBarIcons shape='chart' />, title: 'Advanced Statistics', nestedItems: [
        { title: 'Users', link: '/administration/statistics/users', validateFct: () => check((actions as any).USERS_STATS) },
        { title: 'Groups', link: '/administration/statistics/groups', validateFct: () => check((actions as any).GROUPS_STATS) },
        { title: 'Profiles', link: '/administration/statistics/profiles', validateFct: () => check([(actions as any).ADMIN_STATS, (actions as any).AGGREGATED_STATS]) },
        { title: 'Sessions', link: '/administration/statistics/sessions', validateFct: () => check((actions as any).ADMIN_STATS) },
