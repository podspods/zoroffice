...
import Toolbar from '../../app/[lang]/monitoring/translationReviews/components/Modals/ModalToolbar';
import {Tm} from '../../app/[lang]/monitoring/translationReviews/components/FeedbackType';
import { dateColumn, radioSelectionColumn, tmFilenameColumn } from '@/components/Columns';
import {
  transformApiResponse
} from '../../app/[lang]/linguisticConfiguration/resources/translationMemory/lib/TranslationMemory';
...
export default function AddToTmModal({open, onConfirm, onClose, languagePair}: Props) {
  const [refreshInterval, setRefreshInterval] = useState<RefreshRate>('Never');

  const {data, isLoading, isValidating, mutate} = useSWR(
    Apis.feedback.listTM(languagePair),
    {
